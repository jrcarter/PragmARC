...
-- **************************************************************************
--
-- Implementation of the Threefish cipher for blocks of 1024 bits (Threefish-1024)
--
...
package PragmARC.Encryption.Threefish.Block_1024 with Pure is
   ...
   Num_Rounds : constant := 80; -- For full encryption
   ...
   subtype Block_As_Bytes is Byte_List (1 .. 128); -- 16 consecutive Word_As_Bytes
