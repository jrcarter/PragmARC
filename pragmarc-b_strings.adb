...
package body PragmARC.B_Strings is
   function To_String (Source : in B_String) return String is
      (Source.Value (1 .. Source.Len) );

   function To_B_String (Source : in String) return B_String is
   ...
   function Length (Source :in  B_String) return Natural is
      (Source.Len);
   ...
   function "=" (Left : in B_String; Right : in B_String) return Boolean is
